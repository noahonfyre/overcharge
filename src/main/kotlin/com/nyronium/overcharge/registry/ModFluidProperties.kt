...
object ModFluidProperties {
    ...
    val VOLATILE_SOLUTION: FluidData = FLUID_PROPERTIES.register("volatile_solution",
        FluidProperties.create()
            .still(ResourceLocation.tryBuild(Overcharge.ID, "block/volatile_solution_still"))
            .flowing(ResourceLocation.tryBuild(Overcharge.ID, "block/volatile_solution_flow"))
            .overlay(ResourceLocation.parse("textures/block/water_overlay"))
            .screenOverlay(ResourceLocation.parse("textures/misc/underwater.png"))
            .viscosity(800)
            .density(800)
    ...
    val DESTABILIZED_SILICON: FluidData = FLUID_PROPERTIES.register("destabilized_silicon",
        FluidProperties.create()
            .still(ResourceLocation.tryBuild(Overcharge.ID, "block/destabilized_silicon_still"))
            .flowing(ResourceLocation.tryBuild(Overcharge.ID, "block/destabilized_silicon_flow"))
            .overlay(ResourceLocation.parse("textures/block/water_overlay"))
            .screenOverlay(ResourceLocation.parse("textures/misc/underwater.png"))
            .viscosity(800)
            .density(800)
